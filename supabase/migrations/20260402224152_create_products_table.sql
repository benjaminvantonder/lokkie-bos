...
INSERT INTO products (title, description, category_id, size, price, image_url, is_available) VALUES
  ...
  ('Watercolour Art - Large', 'Stunning watercolour masterpiece on A3 paper', (SELECT id FROM categories WHERE name = 'Watercolour' LIMIT 1), 'A3', 480, 'https://images.pexels.com/photos/207962/pexels-photo-207962.jpeg?auto=compress&cs=tinysrgb&w=800', true),
